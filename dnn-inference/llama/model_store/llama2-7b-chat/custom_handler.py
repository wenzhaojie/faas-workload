...
class LlamaHandler(BaseHandler, ABC):
    ...
    def initialize(self, ctx: Context):
        ...
        # log model_path
        logger.info("Model %s model_path: %s", ctx.model_name, model_path)
        ...
        logger.info("Model %s AutoModelForCausalLM.from_pretrained finish!")
        ...
        logger.info("Model %s AutoTokenizer.from_pretrained finish!")

        self.model.resize_token_embeddings(self.model.config.vocab_size + 1) 

        logger.info("Model %s model.resize_token_embeddings finish!")
